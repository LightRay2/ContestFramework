...
namespace GifTransformer
{
    public partial class Form1 : Form
    {
        ...
        {
            Image gif = Image.FromFile("image.gif");
            ...
            for (int i = 0; i < frames; i++)
            {
                ...
                Rectangle destRegion = new Rectangle(gif.Width * (i%6), gif.Height*(i/6), gif.Width, gif.Height);
            ...
            resultingImage = ResizeImage(resultingImage, 1024, 1024);


            resultingImage.Save("beautiful3.png", ImageFormat.Png);
        }
