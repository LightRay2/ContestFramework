...
namespace SoccerPlayers
{
    public class SimpleGameNormal
    {
        ...
        void Go()
        {
            ...
            Point enemy = new SoccerPlayers.SimpleGameNormal.Point { x = ReadDouble(), y = ReadDouble() };
            int ballcount = ReadInt();
            var balls = new List<Point>();
            for (int i = 0; i < ballcount; i++)
            {
                balls.Add(new SoccerPlayers.SimpleGameNormal.Point { x = ReadDouble(), y = ReadDouble() });
            }
                Point aim = new SoccerPlayers.SimpleGameNormal.Point { x = we.x, y = we.y };
